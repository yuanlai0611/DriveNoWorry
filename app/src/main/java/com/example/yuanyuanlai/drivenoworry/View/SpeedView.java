package com.example.yuanyuanlai.drivenoworry.View;
...
public class SpeedView extends View {
    ...
    private String color_bg_outcircle = "#fa682e";
    private String color_bg_incircle = "#f17743";
    private String color_progress = "#ef7a50";
